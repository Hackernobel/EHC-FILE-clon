...
while attemps < 12345677901:
    ...
    if username == 'EHC' and password == '2024':
...
os.system('espeak -a 300 " Join,   My,  TELEGRAM,  EHC,  CYBER99"')
#LOGO
def banner():
	print("""%s
...
\033[0;95m$$$$$$$$\ $$\   $$\  $$$$$$\        $$$$$$$\  $$\   $$\ 
\033[0;91m$$  _____|$$ |  $$ |$$  __$$\       $$  __$$\ $$ | $$  |
\033[0;92m$$ |      $$ |  $$ |$$ /  \__|      $$ |  $$ |$$ |$$  / 
\033[0;91m$$$$$\    $$$$$$$$ |$$ |            $$$$$$$\ |$$$$$  /  
\033[0;95m$$  __|   $$  __$$ |$$ |            $$  __$$\ $$  $$<   
\033[0;95m$$ |      $$ |  $$ |$$ |  $$\       $$ |  $$ |$$ |\$$\  
\033[0;95m$$$$$$$$\ $$ |  $$ |\$$$$$$  |      $$$$$$$  |$$ | \$$\ 
\033[0;95m\________|\__|  \__| \______/       \_______/ \__|  \__|
  
\033[1;92m
                                                              
[+] OWNER   : EHC-NOBEL-BK
[+] Telegram : EHC-CYBER99
[+] Github   : NOBEL-BK
[+] Version  : 1.1
[+] Tool     : Free ViP
...
def Settings():
	...
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mMOBILE\x1b[1;92m [Dsonfm]')
